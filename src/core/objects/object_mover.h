...
public:
	 ...
	 *                         in millimeters.
	 */
	void setCornerTolerance(const qreal corner_tolerance);
	...
	/**
	 * Moves the elements.
	 * @param move_opposite_handles Opposite curve handles either move together
	 *        around its anchor point, operate in "click in" mode or move
	 *        independently.
