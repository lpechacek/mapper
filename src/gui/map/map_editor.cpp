...
#include "tools/radial_shift_tool.h"
...
void MapEditorController::assignKeyboardShortcuts()
{
	...
	findAction("radialshift")->setShortcut(QKeySequence(tr("Ctrl+Shift+R")));
...
void MapEditorController::createActions()
{
	...
	radial_shift_act = newToolAction("radialshift", tr("Radial shift"), this, SLOT(radialShiftClicked()), "tool-radial-shift.png", QString{}, "toolbars.html#tool_radial_shift");
...
void MapEditorController::createMenuAndToolbars()
{
	...
	tools_menu->addAction(radial_shift_act);
	...
	toolbar_editing->addAction(radial_shift_act);
...
void MapEditorController::updateObjectDependentActions()
{
	...
	radial_shift_act->setEnabled(have_area || have_line);
	radial_shift_act->setStatusTip(tr("Move lines and area borders in and out.") + (radial_shift_act->isEnabled() ? QString{} : QString(QLatin1Char(' ') + tr("Select at least one line or area object to activate this tool."))));
...
void MapEditorController::radialShiftClicked()
{
	setTool(new RadialShiftTool(this, radial_shift_act));
}
