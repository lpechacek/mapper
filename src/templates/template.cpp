...
void Template::drawOntoTemplate(not_null<MapCoordF*> coords, int num_coords, const QColor& color, qreal width, QRectF map_bbox, bool filled)
{
	...
	drawOntoTemplateImpl(coords, num_coords, color, width, filled);
...
void Template::drawOntoTemplateImpl(MapCoordF* /*coords*/, int /*num_coords*/, const QColor& /*color*/, qreal /*width*/, bool /*filled*/)
{
	// nothing
}
