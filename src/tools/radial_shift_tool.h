...
#ifndef OPENORIENTEERING_RADIAL_SHIFT_TOOL_H
#define OPENORIENTEERING_RADIAL_SHIFT_TOOL_H
 ...
 */
class RadialShiftTool : public MapEditorToolBase
{
...
Q_OBJECT
public:
	RadialShiftTool(MapEditorController* editor, QAction* tool_action);
	~RadialShiftTool();
