...
namespace literal {
	static const QLatin1String operations {"operations"};
	static const QLatin1String case_id {"case_id"};
	static const QLatin1String description {"description"};
	static const QLatin1String vertical_displacements {"vertical_displacements"};
	static const QLatin1String Union {"Union"};
	static const QLatin1String Intersection {"Intersection"};
	static const QLatin1String Difference {"Difference"};
	static const QLatin1String XOr {"XOr"};
	static const QLatin1String MergeHoles {"MergeHoles"};
}  // namespace literal
...
Q_DECLARE_METATYPE(BooleanTool::Operation)
...
private slots: // NOLINT(readability-redundant-access-specifiers)
	...
	void testBooleanTool_data()
	{
		...
		source_part->applyOnAllObjects([this](Object* object) {
			...
			{
				auto const row_descr = QLatin1String {"%1 %2, %3"}
	...
	void testBooleanTool() // NOLINT(readability-function-cognitive-complexity)
	{
		...
		auto const out_filename = QLatin1String {"%1boolean_tool_t-%2%3.xmap"}
		...
		auto const error_message = QLatin1String {"There is %1 for further analysis."}
		                           .arg(out_filename);
#else
		auto const error_message = QLatin1String {"Build Mapper in debug mode to get a file for further analysis."};
#endif
